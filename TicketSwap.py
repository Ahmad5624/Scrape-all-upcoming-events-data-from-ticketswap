...
def RunScrapper():
    ...
    url = "https://www.ticketswap.com/browse?period=today"
    url1 = "https://www.ticketswap.com/browse"
    ...
    while True:
        ...
        choice = input()
        if choice == '1':
            Click_on_the_location(url)
            break
        elif choice == '2':
            Click_on_the_location(url1)
            break
...
def Get_the_links():
    ...
    while True:
        try:
            ...
            driver.find_element(By.XPATH, value="//button[@class = 'e1mdulau0 css-1qp2od eh8fd9012']").click()
            WebDriverWait(driver, 5).until(
                expected_conditions.presence_of_element_located(
